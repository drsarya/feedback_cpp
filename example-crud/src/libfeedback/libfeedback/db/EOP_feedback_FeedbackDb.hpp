...
public:
	...
	QUERY(createFeedback,
		"insert into  feedback(description, commentator_user_id, commentator_login, show_commentator_login, course_id, owner_course_user_id ) values "
		...
		QUERY(getFeedbacks,
			...
			"   is_banned as isBanned , ban_description as banDescription, ban_date as banDate FROM  feedback order by creation_date desc LIMIT :limit OFFSET :offset;",
		...
		QUERY(getFeedbackById,
			"SELECT id, description, commentator_user_id as commentatorUserId, commentator_login as commentatorLogin, show_commentator_login as showCommentatorLogin, course_id as courseId, owner_course_user_id as ownerCourseUserId, is_read_by_owner_course as isReadByOwnerCourse,"
			"  owner_course_answer_comment as ownerCourseAnswerComment, owner_course_answer_comment_creation_date as ownerCourseAnswerCommentCreationDate, creation_date as creationDate, update_date as updateDate, "
			"   is_banned as isBanned , ban_description as banDescription, ban_date as banDate FROM  feedback WHERE id=:feedbackId ;",
			PARAM(oatpp::Int32, feedbackId))

		QUERY(getFeedbackByUserId,
			"SELECT id, description, commentator_user_id as commentatorUserId, commentator_login as commentatorLogin, show_commentator_login as showCommentatorLogin, course_id as courseId, owner_course_user_id as ownerCourseUserId, is_read_by_owner_course as isReadByOwnerCourse,"
			"  owner_course_answer_comment as ownerCourseAnswerComment, owner_course_answer_comment_creation_date as ownerCourseAnswerCommentCreationDate, creation_date as creationDate, update_date as updateDate, "
			"   is_banned as isBanned , ban_description as banDescription, ban_date as banDate FROM  feedback WHERE commentator_user_id=:userId order by creation_date desc LIMIT :limit OFFSET :offset;",
		...
		QUERY(getFeedbackByCourseId,
			"SELECT id, description, commentator_user_id as commentatorUserId, commentator_login as commentatorLogin, show_commentator_login as showCommentatorLogin, course_id as courseId, owner_course_user_id as ownerCourseUserId, is_read_by_owner_course as isReadByOwnerCourse,"
			"  owner_course_answer_comment as ownerCourseAnswerComment, owner_course_answer_comment_creation_date as ownerCourseAnswerCommentCreationDate, creation_date as creationDate, update_date as updateDate, "
			"   is_banned as isBanned , ban_description as banDescription, ban_date as banDate FROM  feedback where course_id=:courseId and is_banned=false and is_read_by_owner_course=true order by creation_date desc LIMIT :limit OFFSET :offset;",
		...
		QUERY(getFeedbackByCourseOwner,
			"SELECT id, description, commentator_user_id as commentatorUserId, commentator_login as commentatorLogin, show_commentator_login as showCommentatorLogin, course_id as courseId, owner_course_user_id as ownerCourseUserId, is_read_by_owner_course as isReadByOwnerCourse,"
			"  owner_course_answer_comment as ownerCourseAnswerComment, owner_course_answer_comment_creation_date as ownerCourseAnswerCommentCreationDate, creation_date as creationDate, update_date as updateDate, "
			"   is_banned as isBanned , ban_description as banDescription, ban_date as banDate FROM feedback where owner_course_user_id=:ownerCourseUserId order by creation_date desc LIMIT :limit OFFSET :offset;",
