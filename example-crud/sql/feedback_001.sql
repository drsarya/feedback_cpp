...
comment
on column feedback.feedback_notification.is_sent is 'Отправлено ли уведомление';
comment
on column feedback.feedback_notification.read_status is 'Статус прочтения уведомления';
comment
